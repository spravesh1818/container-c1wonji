...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-c1wonji.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-c1wonji.containers.anotherwebservice.com/
...
```
git clone git@github.com:spravesh1818/container-c1wonji.git
cd container-c1wonji
```
...
```
docker attach container-c1wonji
```
